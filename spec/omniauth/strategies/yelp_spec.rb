...
describe OmniAuth::Strategies::Yelp do
  before :each do
  ...
  subject do    
    OmniAuth::Strategies::Yelp.new(nil, @options || {}).tap do |strategy|
  ...
  describe '#client' do
    it 'has correct Yelp site' do
      subject.client.site.should eq('http://api.yelp.com')
    end
  ...
  describe '#info' do
    before :each do
      @raw_info = {
        ...
        'photo' => 'https://img-s.Yelp.com/userpix_thumbs/blank_boy.jpg',
        'homeCity' => 'Chicago'
      }
    ...
    context 'when data is present in raw info' do
      ...
      it 'returns the user image' do
        subject.info[:image].should eq('https://img-s.Yelp.com/userpix_thumbs/blank_boy.jpg')
      end
